...
## Per1 (C157B1)
refit(obj_list[[1]], samplename=samples[1], sex=sex, ploidy=2, purity=0.34, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## Per2 (C157B2)
refit(obj_list[[2]], samplename=samples[2], sex=sex, ploidy=2, purity=0.37, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## Per3 (C157Di1)
refit(obj_list[[3]], samplename=samples[3], sex=sex, ploidy=2, purity=0.28, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## Per4 (C157Di2)
refit(obj_list[[4]], samplename=samples[4], sex=sex, ploidy=2, purity=0.25, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## LN1 (C157LN4)
refit(obj_list[[5]], samplename=samples[5], sex=sex, ploidy=2, purity=0.46, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## N1
refit(obj_list[[6]], samplename=samples[6], sex=sex, ploidy=2, purity=1, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))
...
## PT7 (C157P10)
refit(obj_list[[8]], samplename=samples[8], sex=sex, ploidy=2, purity=0.37, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT2
refit(obj_list[[9]], samplename=samples[9], sex=sex, ploidy=2, purity=0.53, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT3
refit(obj_list[[10]], samplename=samples[10], sex=sex, ploidy=2, purity=0.50, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT4
refit(obj_list[[11]], samplename=samples[11], sex=sex, ploidy=2, purity=0.60, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT5 (C157P6)
refit(obj_list[[12]], samplename=samples[12], sex=sex, ploidy=2, purity=0.50, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT6 (C157P9)
refit(obj_list[[13]], samplename=samples[13], sex=sex, ploidy=2, purity=0.25, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## PT8 (C157TD1)
refit(obj_list[[14]], samplename=samples[14], sex=sex, ploidy=2, purity=0.48, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## LN2a (C157TD2a)
refit(obj_list[[15]], samplename=samples[15], sex=sex, ploidy=2, purity=0.50, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## LN2b (C157TD2b)
refit(obj_list[[16]], samplename=samples[16], sex=sex, ploidy=2, purity=0.51, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))

## TD1 (C157TD7)
refit(obj_list[[17]], samplename=samples[17], sex=sex, ploidy=2, purity=0.45, save=T, output_dir=here(paste0('processed_data/copynumber/',patient)))
